...
export const CONTRACT_ADDRESSES = {
  ...
  spectreToken:
    import.meta.env.VITE_SPECTRE_TOKEN_ADDRESS ||
    "0x751111805C4c8a014da9f040199d040788d61347",
  // V3: Original vault (for backwards compatibility)
  spectreVault:
    import.meta.env.VITE_SPECTRE_VAULT_ADDRESS ||
    "0x7e3188bdB5DcE28735274389013d3b0194BDfA84",
...
export const APP_CONFIG = {
  ...
  appDescription:
    "Privacy-preserving DeFi using Fully Homomorphic Encryption (CoFHE)",
